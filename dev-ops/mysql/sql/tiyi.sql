...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '音频分析项目' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `analysis_item` VALUES (4, '频谱图', '频谱图是显示音频信号强度（功率）随频率和时间变化的图像，是分析音频信号频率成分的主要工具。频谱图可以展示音乐或语音的频率成分以及这些成分如何随时间变化，是音频信号处理中的常用工具。', 2, '2024-06-09 17:55:16', '2024-06-09 17:55:16');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'maskira', '$2b$12$H3aUAJ5N/qeGvzGjr1/xH.lDSnKanpTMqW8/1xdcniBu9.nCZTIKS', 3100, NULL, '在签名中展现你的个性吧！', '2024-06-08 10:40:31', '2024-06-09 22:48:46');
